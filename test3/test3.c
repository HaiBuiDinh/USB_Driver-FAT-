...
static int pen_probe(struct usb_interface *interface, const struct usb_device_id *id)
{
	...
	{
		/* Something prevented us from registering this driverr */
		err("Not able to get a minor for ths device.");
	}
	else
	{
...
static int __init pen_init(void)
{
	...
	if ((resutl = usb_register(&pen_driver)))
	{
		err("usb_register faild. Error number %d", result);
	}
	return result;
}
